...
public class CinemaInitServiceImpl  implements ICinemaInitService{
	...
	public void initSeance() {
		...
		Stream.of("12:00","17:00","19:00","21:00").forEach(s->{
	...
	public void initFilms() {
		double[] durees = new double[] {1,1.5,2.5,3.0,5.0};
		List<Categorie> categories = categorieRepository.findAll();
		Stream.of("King","saw","Training","justice","ww2")
		.forEach(titreFilm->{
			Film film = new Film();
	...
	public void initProjections() {
		double[] prices = new double[] {30,50,70,80,110,40};
